...
type Response struct {
	...
	// delegam em http.ServeFile — e essa função usa o pedido para
	// suportar corretamente cabeçalhos condicionais (If-Modified-Since)
	// e pedidos parciais (Range), por exemplo em downloads retomáveis.
	req *http.Request
...
// *http.Request nativos, usado internamente pelo App.ServeHTTP.
...
// Redirect envia um redirecionamento HTTP para a URL indicada. O
// código de estado é opcional e usa 302 (Found) por predefinição,
// à semelhança do Express.
//
// Exemplo:
//
...
// Render renderiza a view identificada por name através do motor de
// templates indicado e escreve o HTML resultante na resposta.
//
// Exemplo:
//
